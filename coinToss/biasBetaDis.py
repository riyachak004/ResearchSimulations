...
def biasBetaDis(): 
    ...
    plt.legend()
    imagePath = os.path.join(my_path, f'visuals/betaDist_α={alpha_value}_β={beta_value}_cdf')
    ...
    plt.legend()
    imagePath = os.path.join(my_path, f'visuals/betaDist_α={alpha_value}_β={beta_value}_pdf_histogram_overlay')
